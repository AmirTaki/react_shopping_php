...
import { createImageSliderSessionThunk } from "../redux/actionsSwiper";

const CreateSessionImageSliderPA = () => {
                ...
                <div className="flex justify-center items-center">
                    <input 
                        onClick={(event: React.MouseEvent<HTMLDivElement, MouseEvent>) => {
                            ...
                            dispatch(createImageSliderSessionThunk(formData));
                        }}                        
...
export default CreateSessionImageSliderPA;