...
import { onBodyWebkit, onLoadingWebkit, onSetItemsWebkit, onSetURLWebkit, onTitleWebkit } from "../redux/webkitSlice";
import { readingItemWebkitScrollSessionThunk, editItemWebkitScrollSessionThunk} from "../redux/actionsWebkit";



const EditSessionWebkitScrollPA = () => {
    ...
    useEffect(() => {
        ...
        dispatch(readingItemWebkitScrollSessionThunk({id: Number(id)}))
    }, [])
                ...
                <div className="flex justify-center items-center">
                    <input 
                        onClick={(event: React.MouseEvent<HTMLDivElement, MouseEvent>) => {
                            ...
                            dispatch(editItemWebkitScrollSessionThunk({formData: formData, id: Number(id)}));
                        }}                        
...
export default EditSessionWebkitScrollPA;