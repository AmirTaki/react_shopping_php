...
import { readingItemSliderPageSessionThunk, editItemSliderPageSessionThunk } from "../redux/actionsGridSlider";

const EditSessionSliderPagePA = () => {
    ...
    useEffect(() => {
        ...
        dispatch(readingItemSliderPageSessionThunk({id: Number(id)}))
    }, [])
                ...
                <div className="flex justify-center items-center">
                    <input 
                        onClick={(event: React.MouseEvent<HTMLDivElement, MouseEvent>) => {
                            ...
                            dispatch(editItemSliderPageSessionThunk({formData: formData, id: Number(id)}));
                        }}                        
...
export default EditSessionSliderPagePA;