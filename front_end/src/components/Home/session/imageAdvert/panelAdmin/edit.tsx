...
import { readingItemImageAdvertSessionThunk, editItemImageAdvertSessionThunk } from "../redux/actionAdvert";


const EditSessionImageAdvertPA = () => {
    ...
    useEffect(() => {
        ...
        dispatch(readingItemImageAdvertSessionThunk({id: Number(id)}))
    }, [])
                ...
                <div className="flex justify-center items-center">
                    <input 
                        onClick={(event: React.MouseEvent<HTMLDivElement, MouseEvent>) => {
                            ...
                            dispatch(editItemImageAdvertSessionThunk({formData: formData, id: Number(id)}));
                        }}                        
...
export default EditSessionImageAdvertPA;