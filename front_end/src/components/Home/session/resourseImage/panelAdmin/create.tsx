...
import { createResourceImageSessionThunk } from "../redux/actionsResourse";


const CreateSessionResourceImagePA = () => {
                ...
                <div className="flex justify-center items-center">
                    <input 
                        onClick={(event: React.MouseEvent<HTMLDivElement, MouseEvent>) => {
                            ...
                            dispatch(createResourceImageSessionThunk(formData));
                        }}                        
...
export default CreateSessionResourceImagePA;