...
import { createCircleSlidersSessionThunk } from "../redux/actionsCircle";

const CreateCircleSliderSessionPA = () => {
    ...
    useEffect(() => {
        if(addItems){
            navigate('/panelAdmin/sessionCircleSlider')
            dispatch(onSetItemsCircle())
        }
    }, [addItems])
    ...
    const  handlerImageChange = (e: React.ChangeEvent<HTMLInputElement>) => {
        ...
        if(file){
            ...
            reader.onload = () => {
                dispatch(onSetURLCircle({result: reader.result}))
            }
            ...
            >
                ...
                <div className="flex gap-5 items-center justify-center">
                    ...
                    <input 
                        ...
                        onChange={(e: React.ChangeEvent<HTMLInputElement>) => {dispatch(onTitleCircle({title: e.target.value}))}}
                    ></input>
                </div>
                <div className="text-gray-500 py-5">message:
                    <span className="text-red-600 px-2">
                ...
                <div className="flex justify-center items-center">
                    <input 
                        onClick={(event: React.MouseEvent<HTMLDivElement, MouseEvent>) => {
                            ...
                            dispatch(createCircleSlidersSessionThunk(formData));
                        }}                        
...
export default CreateCircleSliderSessionPA;