...
import { editItemFooterThunk, readingItemFooterThunk } from "../redux/actionsItemFooter";


const EditItemFooterPA = () => {
    const {id} = useParams()
    ...
    useEffect(() => {
        ...
        dispatch(readingItemFooterThunk({id: Number(id)}))
    }, [])
                ...
                <div className="flex justify-center items-center">
                    <input 
                        onClick={(event: React.MouseEvent<HTMLDivElement, MouseEvent>) => {
                            ...
                            dispatch(editItemFooterThunk({id: Number(id),title : title.name, item: item.name}));
                        }}                        
                        type="submit"
                        value = "update" 
...
export default EditItemFooterPA;