...
import { readingItemImageMenuThunk, editImageMenuHeadersThunk } from "../redux/actionsImageMenu";

const EditMegaMenuImagePA = () => {
    ...
    useEffect(() => {
        ...
        dispatch(readingItemImageMenuThunk({id: Number(id)}))
                ...
                <div className="flex justify-center items-center">
                    <input 
                        onClick={(event: React.MouseEvent<HTMLDivElement, MouseEvent>) => {
                            ...
                            dispatch(editImageMenuHeadersThunk({formData: formData, id: Number(id)}));
                        }}                        
...
export default EditMegaMenuImagePA;