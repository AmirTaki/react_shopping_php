...
import { editItemsListHeadersThunk, readingItemListHeadersThunk } from "../redux/actionsMenuList";


const EditListMenuHeadersPA = () => {
    const {id} = useParams()
    ...
    useEffect(() => {
        ...
        dispatch(readingItemListHeadersThunk({id: Number(id)}))
                ...
                <div className="flex justify-center items-center">
                    <input 
                        onClick={(event: React.MouseEvent<HTMLDivElement, MouseEvent>) => {
                            ...
                            dispatch(editItemsListHeadersThunk({id: Number(id),title : title.name, list: list.name}));
                        }}                        
                        type="submit"
                        value = "update" 
...
export default EditListMenuHeadersPA;