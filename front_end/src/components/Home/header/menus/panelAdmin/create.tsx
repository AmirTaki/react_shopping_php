...
import { createMenusHeaders } from "../redux/actionsMenus";

const CreateMenusPanelAdmin = () => {
                ...
                <div className="flex justify-center items-center">
                    <input 
                        onClick={(event: React.MouseEvent<HTMLDivElement, MouseEvent>) => {
                            ...
                            dispatch(createMenusHeaders({title : title.name}));
                        }}
...
export default CreateMenusPanelAdmin;